...
Func((1, 5), 'glBeginQuery', [P(tGLenum, 'target', None, QueryTarget), P(tGLQuery, 'id')], None)
...
Func((4, 0), 'glBeginQueryIndexed', [P(tGLenum, 'target', None, QueryTarget), P(tGLuint, 'index'), P(tGLQuery, 'id')], None)
